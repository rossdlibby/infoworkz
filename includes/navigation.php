...
<div class="w-nav normal-header" id="myaffix" data-collapse="medium" data-animation="default" data-duration="400" data-contain="1">
	<div class="w-container">
		<a class="w-nav-brand brand-logo" href="/"><img src="images/logo.jpg" width="200" alt="logo.jpg">
		</a>
		<nav class="w-nav-menu w-clearfix nav-menu" role="navigation">
			<?php foreach($menu as $item) {
				...
				{
					?>
					<a class="w-nav-link nav-link" href="<?php echo $item[1]; ?>" target="<?php echo $item[2]; ?>"><?php echo $item[0]; ?></a>
					<?php
				} else {
					?>
										...
										<div class="space margin-bottom">
											...
											<?php
												foreach($section[1] as $link)
												{
													?>
													<li>
														<a class="w-clearfix w-inline-block mega-item-list" href="<?php echo $link[1]; ?>" target="<?php echo $link[2]; ?>">
